...
class FavoriteMovieSearchView {
  getTemplate() {
    return `
       <div class="content">
       <h2 class="content__heading mb-2">Your Liked Movie</h2>
       <h3 class="content__heading mb-1">Search</h3>
       <input id="query" type="text" class="search" placeholder="Please input your movie">
